...
const GameBoard = ({
  ...
  return (
    <>
      <div className="origin-left /scale-[0.7] /average:scale-[1] w-[320px] relative z-[1] overflow-hidden aspect-square  bg-block dark:bg-dark-block flex items-center justify-center ">
